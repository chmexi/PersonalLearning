...
class DaoHenRepository(private val context: Context) {
    ...
    private fun DaoHenEntry.toDto(): DaoHenDto {
        return DaoHenDto(
            date = date,
            q1 = q1.ifBlank { facts },
            q2 = q2.ifBlank { emotions },
            q3 = q3,
            q4 = q4,
            q5 = q5,
            q6 = q6.ifBlank { stone },
            q7 = q7.ifBlank { betterChoice },
            transcript = transcript,
            facts = facts.ifBlank { q1 },
            emotions = emotions.ifBlank { q2 },
            stone = stone.ifBlank { q6 },
            betterChoice = betterChoice.ifBlank { q7 },
    ...
    private fun DaoHenDto.toEntry(syncStatus: Int): DaoHenEntry {
        return DaoHenEntry(
            ...
            facts = facts.orEmpty().ifBlank { q1.orEmpty() },
            emotions = emotions.orEmpty().ifBlank { q2.orEmpty() },
            stone = stone.orEmpty().ifBlank { q6.orEmpty() },
            betterChoice = betterChoice.orEmpty().ifBlank { q7.orEmpty() },
            aiQuestion = aiQuestion.orEmpty(),
            analysisSource = analysisSource.orEmpty(),
